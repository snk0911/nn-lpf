...
# Using the wavelet low pass filter method from WaveCNet. The other methods are not for classification purposes
...
class DWT_2D_tiny(Module):
    ...
    def __init__(self, wavelet_type):
        ...
        :param wavelet_type: pywt.wavelist(); in the paper, 'chx.y' denotes 'biorx.y'.
        """
